public class Player extends Creature{
  ...
  public Player(int h, int d, int x, int y, String n, char graph, babiesToCollect){
    super(int h, int d, int x, int y, String n, char graph);//defines inherited variables
